...
[LINK - Como agregar un manifest](https://web.dev/articles/add-manifest?hl=es)
[LINK - Styles IOS](https://medium.com/appscope/designing-native-like-progressive-web-apps-for-ios-1b3cdda1d0e8)

> Important usar el manifest en el index
